...
module FiniteSeq =
  ...
  /// Returns the average of the elements in the sequence.
  /// The elements are averaged using the <c>+</c> operator, <c>DivideByInt</c> method and <c>Zero</c> property associated with the element type.
  /// Returns None if the input sequence is empty.
  /// </summary>
  let inline tryAverage xs = averageSafe xs |> Result.toOption
  ...
  /// Returns None if the input sequence is empty.
  /// </summary>
  let inline tryAverageBy projection xs = averageBySafe projection xs |> Result.toOption
  ...
  /// </summary>
  let inline tryMax<'a when 'a : comparison> (xs : FiniteSeq<'a>) = maxSafe xs |> Result.toOption
  ...
  /// Returns None if the sequence is empty.
  /// </summary>
  let inline tryMaxBy<'a, 'b when 'b : comparison> (projection:'a -> 'b) (xs : FiniteSeq<'a>) = maxBySafe projection xs |> Result.toOption
  ...
  /// Returns None if the sequence is empty.
  /// </summary>
  let inline tryMin<'a when 'a : comparison> (xs : FiniteSeq<'a>) = minSafe xs |> Result.toOption
  ...
  /// Returns None if the sequence is empty.
  /// </summary>
  let inline tryMinBy<'a, 'b when 'b : comparison> (projection:'a -> 'b) (xs : FiniteSeq<'a>) = minBySafe projection xs |> Result.toOption
  ...
  /// Returns None if the sequence is empty.
  /// </summary>
  let inline tryReduceBack f xs = reduceBackSafe f xs |> Result.toOption
  ...
  /// <summary>
  /// Returns the transpose of the given sequence of sequences. Returns None if
  /// the input sequences differ in length. 
  /// </summary>
  ...
  /// <summary>
  /// Returns a sequence that yields sliding windows containing elements drawn from the input sequence. Each window is returned as a fresh fseq.
  /// Returns None if the size is zero or negative.
  /// </summary>
...
module FSeq =
  ...
  /// Returns None if the input sequence is empty.
  /// </summary>
  let inline tryAverage (xs : _ fseq) = FiniteSeq.average' xs |> Result.toOption
  ...
  /// Returns None if the <c>size</c> is less than or equal to zero.
  /// </summary>
  let inline tryChunkBySize size xs : Option<_ fseq> = chunkBySizeSafe size xs |> Result.toOption
  ...
  /// Returns None if the sequence is empty.
  /// </summary>
  let inline tryMax<'a when 'a : comparison> (xs : 'a fseq) = FiniteSeq.max' xs |> Result.toOption
  ...
  /// Returns None if the sequence is empty.
  /// </summary>
  let inline tryMaxBy<'a, 'b when 'b : comparison> (projection:'a -> 'b) (xs : 'a fseq) = FiniteSeq.maxBy' projection xs |> Result.toOption
  ...
  /// Returns None if the sequence is empty.
  /// </summary>
  let inline tryMin<'a when 'a : comparison> (xs : 'a fseq) = FiniteSeq.min' xs |> Result.toOption
  ...
  /// Returns None if the sequence is empty.
  /// </summary>
  let inline tryMinBy<'a, 'b when 'b : comparison> (projection:'a -> 'b) (xs : 'a fseq) = FiniteSeq.minBy' projection xs |> Result.toOption
  ...
  module NonEmpty =
    ...
    /// </summary>
    let inline tryOfFSeq xs = ofFSeqSafe xs |> Result.toOption
    ...
    /// Returns None if the size is zero or negative.
    /// </summary>
    let inline tryWindowed n xs = windowed' n xs |> Result.toOption
